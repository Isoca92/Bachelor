...
\end{align*}
Diese Funktion versieht anhand von Anfrage-SMARTS, Ziel-SMARTS und einen Liste über die bestehenden \textit{Label}, beide SMARTS-Ausdrücke mit \textit{Labeln} zur eindeutigen Kennzeichnung und gibt diese zurück.
\begin{align*}
...
\end{flalign*}
Anhand von Anfrage-SMARTS, Ziel-SMARTS und Teilmengen-Relation in Form eines Bitstrings initialisiert diese Funktion eine Relations-Matrix. Ausgegeben wird die Relations-Matrix, die die Verträglichkeit der Knoten der beiden SMARTS-Ausdrücke repräsentiert.
\begin{flalign*}
