...
Momentan werden bei der Übergabe an das implementierte Verfahren die SMARTS-Ausdrücke überprüft und gegebenenfalls aussortiert. Aussortiert werden SMARTS-Aus-\\drücke, die eine der folgenen Eigenschaften beinhalten:
\begin{itemize}
...
Formel \eqref{eq:fallprob} beschreibt diesen Fall. Es wird kein \textit{Mapping} erkannt, da die Schnitt-Relation Knoten und Kanten der Molekülgraphen unabhängig voneinander beschreibt. Beispiel \ref{bsp:fallprob} zeigt den in \eqref{eq:fallprob} beschriebenen Fall.
